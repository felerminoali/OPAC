...
<!--            --><?php //echo number_format($objBasket->_sub_total, 2); ?>
    ...
    <dt>VAT (
        <span>
<!--            --><?php //echo $objBasket->_vat_rate; ?>
        </span>%):
    </dt>
    <dd class="bl_vat">&pound;
        <span>
<!--            --><?php //echo number_format($objBasket->_vat, 2); ?>
        </span>
    </dd>
    <dt>Total (inc):</dt>
    <dd class="bl_total">&pound;<span>
<!--            --><?php //echo number_format($objBasket->_total, 2); ?>
        </span>
    </dd>
</dl>
