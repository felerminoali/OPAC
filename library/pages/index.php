...
if(Login::isLogged(Login::$_login_lms)){
    Helper::redirect(Login::$_dashboard_lms);
}
...
if ($objForm->isPost('login_email')) {
    ...
    if($objLMS->isUser($objForm->getPost('login_email'), $objForm->getPost('login_password'))){
        Login::loginLMS($objLMS->_id, Url::getCurrentUrl());
    }else{
